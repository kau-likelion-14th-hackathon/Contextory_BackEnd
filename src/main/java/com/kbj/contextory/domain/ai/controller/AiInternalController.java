...
public class AiInternalController {
    ...
    @Operation(summary = "FastAPI 분석 상태 조회", description = "Spring Boot가 FastAPI의 작업 상태를 조회합니다 (Callback 실패 시 보조 수단).")
    @GetMapping("/{jobId}")
    ...
    @Operation(summary = "FastAPI 분석 완료 Callback", description = "FastAPI가 분석 완료 또는 실패 결과를 Spring Boot에 전송합니다.")
